...
public class CodeartifactPrivateLinkUrlFactory implements ArtifactRepositoryUrlFactory {
    ...
    public CodeartifactPrivateLinkUrlFactory(String privateLinkUrl, String domain, String domainOwner) {
        this.privateLinkUrl = privateLinkUrl.endsWith("/") ? privateLinkUrl : privateLinkUrl + "/";
        this.domain = domain;
    ...
    public URL create(HttpExchange exchange) {
        ...
        resourcePath = resourcePath.substring(n + 1);
        URI uri = URI.create(privateLinkUrl + format + "/d/" + domain + "-" + domainOwner
